...
<table class="table" align="center">
	...
	<c:forEach items="${cart}" var="cart">
		<tr>
			<td>${cart.pname}</td>
			<td><input type="text" value="${cart.quantity}" name="quantity"
				required /></td>
			...
			<td><a class="btn btn-success btn-product"
				href="${cp}/delete/${cart.cartItemId}"><span
					class="glyphicon glyphicon-shopping-cart"></span> Delete</a></td>
		</tr>
	</c:forEach>
	<tr>
		<td><a href="/checkout" input type="submit" value="Checkout" /></a></td>
		<td><a class="btn btn-success btn-product" href="${cp}/Bill/"><span
